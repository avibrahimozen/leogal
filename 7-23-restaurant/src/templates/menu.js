...
${LANG_CSS}
  ...
  .feature .pr { grid-column: 2; grid-row: 1 / span 2; font-weight: 700; font-size: 18px; line-height: 1; color: var(--koz); white-space: nowrap; font-variant-numeric: tabular-nums; }
